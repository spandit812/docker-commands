...
<b>To scale number of containers for the service:</b>
  ...
  > docker service ps busybox-svc         --> This shows number of running <b>tasks</b> for the service
  If you have service exposed at port, request will reach to different container every request by round robin fashion
</pre>
